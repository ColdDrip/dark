/*
  ...
  Therefore it can allow the processing to draw GSR value continuously into graph, 
  the base value of GSR varies from different context, in this case it is around 440. 
